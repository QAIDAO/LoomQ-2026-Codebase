...
| `originq_wukong` | 本源悟空超导真机（悟空 180 比特） | 真机 | 180 | 小时级 | 免费额度 | 需注册 + API Token；通过 pyqpanda3 动态查询在线后端 |
...
- *"50 比特电路"* → `originq_wukong` 的标称比特数满足，但仍需检查当前账号权限、在线状态、可用比特和拓扑；不能只按标称容量承诺可立即执行。
