...
class PublicL2ContractTests(unittest.TestCase):
    ...
    def test_invalid_json_is_reported_without_payload_or_secret(self):
        ...
        try:
            environment = {
                ...
                "LOOMQ_LLM_API_KEY": "contract-test-key",
        ...
        self.assertNotIn("contract-test-key", str(caught.exception))

    def test_http_errors_are_normalized_without_echoing_body(self):
