...
```text
平台名称：spinq
平台 job ID：83647256049186026
运行时间：2026-08-25T01:51:48.376513
shots：8192
实际执行的 QASM：starter_kit/circuits/bell_without_measure.qasm
平台返回的原始结果：starter_kit/evidence/files/result_spinq_83647256049186026.json
任务页截图：[选填，填写仓库内路径]
```

```text
平台名称：originq
平台 job ID：6A81E0139F939EE6CC36C5FA529D5A65
运行时间：2026-08-25T04:44:29.193091
shots：8192
实际执行的 QASM：starter_kit/circuits/bell.qasm
平台返回的原始结果：starter_kit/evidence/files/result_originq_6A81E0139F939EE6CC36C5FA529D5A65.json
任务页截图：[选填，填写仓库内路径]
```
